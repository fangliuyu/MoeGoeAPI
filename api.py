...
def api_for_main(req :Request,models: str = def_model,speaker_id:int=0,text: str = "",escape:bool=False,type: str = "",raw_text: str = "",output:str="json"):
    s = time.time()
    # 载入模型信息
    if models == "":
...
@app.get("/{models}")
async def moegoe_for_N(req :Request,models: str="",text: str="",escape:bool=False,type: str="wav",raw_text:str="",output:str="json"):
    return api_for_main(req,models,0,text,escape,type,raw_text,output)

@app.get("/{models}/{id}")
async def moegoe_for_N(req :Request,models: str="",id:int=0,text: str="",escape:bool=False,type: str="wav",raw_text:str="",output:str="json"):
